...
%Reynolds 1 mill    -> f = 0.60 Hz Clean mean 20 - 10 amplitud sine wave (file C10|100_s809.txt)
%Reynolds 1 mill    -> f = 0.62 Hz LEGR mean 20 - 10 amplitud sine wave (file G10|100_s809.txt)
...
OSUdata    = table2array( readtable('/TestData/unesteadyClean_Mean20_Amp10_Re1m.txt'  ) );
%OSUdata    = table2array( readtable('/TestData/unesteadyLEGR_Mean20_Amp10_Re1m.txt'   ) );

%% Experimental conditions
vrelNorm = 112.7*0.3048           ;  % Wind speed (m/s) - 112.7 - 111.0
...
AoA     = 20 - 10*cos(w*tVector) ;                 % Angle of attack variation
