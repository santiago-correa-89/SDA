...
%Reynolds 1 mill    -> f = 0.60 Hz Clean mean 14 - 5.5 amplitud sine wave (file C5|100_s809.txt)
%Reynolds 1 mill    -> f = 0.60 Hz LEGR mean 14 - 5.5 amplitud sine wave (file G5|100_s809.txt)
...
OSUdata    = table2array( readtable('/TestData/unesteadyClean_Mean14_Amp5_Re1m.txt'  ) );
%OSUdata    = table2array( readtable('/TestData/unesteadyLEGR_Mean14_Amp5_Re1m.txt'   ) );

%% Experimental conditions
vrelNorm = 112.3*0.3048           ;  % Wind speed (m/s)  112.3 - 111.1
fHz      = 0.62                   ;  % Oscillator frequency (hz)
...
AoA     = 14 - 5*cos(w*tVector) ; % Angle of attack variation

%% Initiliazation BL model
nBlades     = 1;
nSections   = 1;
T           = [ 2.8, 3.5, 7.0, 9.0 ] ;    %  LBM model time constant Tp, Tf0, Tv0, Tvl
