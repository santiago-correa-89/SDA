...
%Reynolds 1 mill    -> f = 0.60 Hz Clean mean 8 - 5.5 amplitud sine wave (file C5|100_s809.txt)
%Reynolds 1 mill    -> f = 0.60 Hz LEGR mean 8 - 5.5 amplitud sine wave (file G5|100_s809.txt)
...
OSUdata    = table2array( readtable('/TestData/unesteadyClean_Mean8_Amp5_Re1m.txt'  ) );
%OSUdata    = table2array( readtable('/TestData/unesteadyLEGR_Mean8_Amp5_Re1m.txt'   ) );

%% Experimental conditions
vrelNorm = 113.6*0.3048           ;  % Wind speed (m/s)  113.6 - 111.6
