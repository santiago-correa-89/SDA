...
%Reynolds 1 mill    -> f = 0.60 Hz Clean mean 8 - 10 amplitud sine wave (file C10|100_s809.txt)
%Reynolds 1 mill    -> f = 0.62 Hz LEGR mean 8 - 10 amplitud sine wave (file G10|100_s809.txt)
...
OSUdata    = table2array( readtable('/TestData/unesteadyClean_Mean8_Amp10_Re1m.txt'  ) );
%OSUdata    = table2array( readtable('/TestData/unesteadyLEGR_Mean8_Amp10_Re1m.txt'   ) );

%% Experimental conditions
vrelNorm = 110.4*0.3048           ;  % Wind speed (m/s) - 110.4 - 112.7
...
AoA     = 8 - 10*cos(w*tVector) ; % Angle of attack variation
